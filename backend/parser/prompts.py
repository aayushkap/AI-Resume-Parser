def get_extract_info_prompt():
    ...
    2. Years of experience (Return only the number. No 'years'. No other text.)
    3. Highest degree of education (Choose from the following: High School, Bachelor's, MBA, PHD. Return only from these options)
    4. A short summary of the persons skills and work history (Return as a paragraph).
    """


def compare_job_description_prompt(query):
